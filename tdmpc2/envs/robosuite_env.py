...
class RobosuiteEnv(gym.Env):
	...
	def __init__(self, cfg):
		...
		observation_space = (self.cfg.obs_image_size, self.cfg.obs_image_size, 3)
	...
	def _process_observation(self, observation):
		...
		self._last_frame = np.array(Image.fromarray(image).resize((self.cfg.obs_image_size, self.cfg.obs_image_size)))
